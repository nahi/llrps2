...
public class DecoySessionHandler extends SessionHandler {
    ...
    synchronized void sendRoundReady(String newRoundId, String newIteration,
        ...
        LOG.info(String.format("[%s - %s] act as receiving READY", sessionId,
                getAgentName()));
    ...
    synchronized void sendCall() throws RpsSessionException {
        ...
        LOG.info(String.format("[%s - %s] act as receiving MOVE", sessionId,
                getAgentName()));
        ...
        final Rps move = Rps.parse(String.valueOf(strategy.getMove(myMoveStack,
                enemyMoveStack)));
    ...
    synchronized void sendResultUpdate(Rps previousOppositeMove)
        ...
        LOG.info(String.format("[%s - %s] sending RESULT", sessionId,
                getAgentName()));
        enemyMoveStack.add(0, Integer.parseInt(previousOppositeMove
                .getRepresentation()));
